...
- El geoprocesamiento se realiza con diversas herramientas incluidas dentro de ArcToolbox, las cuáles se ejecutan con parámetros definidos y en su mayoría fueron construidas en Python.
- El objetivo del geoprocesamiento es realizar análisis espaciales o administración de datos de tipo vectorial o raster.


  <img src='img/geopro-gif.gif' width='65%' height='65%' class='centerimage'>
...
## Herramientas de geoprocesamiento
  ...
  <img src='img/geopro.png' width='85%' height='85%' class='centerimage'>
